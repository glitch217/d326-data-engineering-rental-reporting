-- 4) detail load
TRUNCATE reporting.rental_detail;
...
-- summary load
TRUNCATE reporting.rental_summary;
...
SELECT
  ...
  ROUND(SUM(d.amount_usd)::numeric, 2) AS total_revenue
FROM reporting.rental_detail AS d
GROUP BY d.category_name, d.rental_month
ORDER BY d.category_name, d.rental_month;
